...
public class FrmClient extends javax.swing.JInternalFrame {
    ...
    private void txtSearchKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyTyped
        if (txtSearch.getText().length() == 0) {
            ...
            try {
                datos = dBClient.fillTableSearchClient(txtSearch.getText());
            } catch (Exception ex) {
                Logger.getLogger(FrmEmployee.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (confirmacion == 0) {
            Client client = new Client();
            client.setIdPerson(Integer.parseInt(txtIdClient.getText()));
            try {
            ...
            JOptionPane.showMessageDialog(rootPane, "El Cliente se ha Eliminado");
            try {
                loadClient();
            } catch (Exception ex) {
                Logger.getLogger(FrmClient.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        Client client = new Client();
        if (txtIdClient.getText().length() == 0) {
            JOptionPane.showMessageDialog(rootPane, "Seleccione un Cliente Primero");
        } else {
            client.setIdPerson(Integer.parseInt(txtIdClient.getText()));
        }
        ...
        try {
            if (dBClient.updateClient(client) == true) {
